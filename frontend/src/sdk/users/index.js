...
import { useGetAllDoctorsQuery, useGetDoctorAptMutation, useGetDoctorInfoQuery, useLogoutDoctorMutation, useUpdateDoctorInfoMutation } from "../../slices/doctorsApiSlice";
...
export class Users {
    ...
    getDocApt(){
        const [data] = useGetDoctorAptMutation();
        return data;
    }
    logout() {
