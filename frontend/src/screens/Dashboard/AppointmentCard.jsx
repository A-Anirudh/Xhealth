...
const AppointmentCard = ({idx,name,time,id}) => {
  ...
  return (
    ...
    boxShadow:'0px 4px 18px 0px rgba(0, 0, 0, 0.15)'
        ...
        <Typography sx={{fontFamily:'Poppins',fontWeight:'500',fontSize:"1.5rem",textAlign:"left",display:'flex',alignItems:'center'}}><Typography sx={{fontFamily:'Poppins',fontWeight:'500',fontSize:"1.5rem",textAlign:"left",color:`${theme.doctor.primary}`}}>{"Sl no : "}</Typography>{idx}</Typography>
