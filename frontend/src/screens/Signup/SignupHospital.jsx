...
export const SignupHospital = () => {
    ...
    return (
        <Box className="maincontainer" sx={{ display: 'flex', boxSizing: "border-box" }} >
            ...
            <Box className='right-section' sx={{ marginBottom:"4rem",  position: 'relative', boxSizing: "border-box", width: '85%', display: 'flex', flexDirection: 'column' }}>
                ...
                >
                    {
                        hospitalDetails.map(({ name, type, label }) => (
                            <Box key={name} sx={{
                                display: "flex",
